...
*   **SignalRChat:** Real-time server-side data pushing to web endpoints. [Source Code](https://github.com/bencarpena/SignalRChat)
*   **Quark:** A modern URL shortener built with Python. [Source Code](https://github.com/bencarpena/quark)

## ⚡ IoT & Hardware Projects
*   **Garage Bouncer:** Level 1 AI that senses and responds to environments via MQTT. [Source Code](https://github.com/bencarpena/arcturus-py)
*   **The Gardener:** Automated plant hydration system. [Source Code](https://github.com/bencarpena/alphard-py-iot)
*   **Weatherman:** MQTT-enabled environmental sensor (Temp/Humidity). [Project Details](https://github.com/bencarpena/alphacentauri-py-iot/blob/main/weatherman.md)
*   **LedZep:** Cloud-integrated Twitter listener for real-time workflow triggers. [Project Details](https://github.com/bencarpena/alphacentauri-py-iot/blob/main/ledzeppelin.md)

## 🛠️ Automation & Infrastructure
*   **Mainframe Automation:** Eliminated manual key-entry workflows using binary search tree algorithms (UPS).
*   **System Automation Scripts:** Collection of shell scripts for infrastructure workflows and system management. [View Repository](https://github.com/bencarpena/binsh)
*   **Enterprise Mobility:** AWS presentation on mobility architecture. [View Slides/Code](https://github.com/bencarpena/aws)
*   **Hash Utilities:** Base64 hashing tools. [Source Code](https://github.com/bencarpena/hash)

## 🎓 Community & Education
*   **SHHS Computer Science:** Volunteer teacher for Raspberry Pi and Python projects at South Houston High School. [Shared Resources](https://github.com/bencarpena/shhs-shared)

---
*Connect with me on [LinkedIn](https://www.linkedin.com/in/bencarpena/) or check out my [GitHub](https://github.com/bencarpena).*
